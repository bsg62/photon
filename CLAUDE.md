...
```bash
cargo run -p xtask -- screenshots                     # eighteen PNGs into target/screenshots/
...
`crates/xtask/screenshots/`) standing in for Tauri's IPC, and writes eighteen PNGs, in both themes,
