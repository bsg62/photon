...
```bash
cargo run -p xtask -- screenshots                     # thirteen PNGs into target/screenshots/
...
`crates/xtask/screenshots/`) standing in for Tauri's IPC, and writes thirteen PNGs, in both themes,
