...
- [ ] In the dialog, Escape and the × close it without writing anything, and the selection behind it is still selected. Type a keyword you have renamed in Settings → Tags: the toast names the *new* name, and that is the name the photos carry.
